...
// Câu 6: Kiểm tra xem tất cả các sản phẩm thuộc danh mục "Accessories" có đang d0uoc75 bán (isAvailable = true) hay không
const areAllAccessoriesAvailable = products
  .filter(product => product.category === 'Accessories')
  .every(product => product.isAvailable === true);

console.log('Tất cả sản phẩm "Accessories" đang được bán:', areAllAccessoriesAvailable);
